...
if __name__ == '__main__':
    ...
    # table = 't_user'
    # sql = f'''
    # INSERT INTO neshield.{table} (id, username, account, password, phone_number, portrait, email, gender, position, tenant_id, department_id, superior_id, salt, is_admin, global_type, local_type, enable_status, del_flag, created_date, created_by, updated_date, updated_by) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s);
    # '''
    # neshieldtestConn.ExecuteSql(sql,
    #                             [1, '超级管理员', 'admin', '542475fa675cfcbe3d0d0bb4a8d6555f', '13800138000', None, None, 0,
    #                              None, 1, 1, None, '95y3', 1, 1, 0, 1, 0, '2020-10-19 14:01:15', 1, None, None])

    table = 't_user'
    portrait = 'null'
    sql = f'''
    INSERT INTO neshield.{table} (id, username, account, password, phone_number, portrait, email, gender, position, tenant_id, department_id, superior_id, salt, is_admin, global_type, local_type, enable_status, del_flag, created_date, created_by, updated_date, updated_by) VALUES (1, '超级管理员', 'admin', '542475fa675cfcbe3d0d0bb4a8d6555f', '13800138000', {portrait}, null, 0, null, 1, 1, null, '95y3', 1, 1, 0, 1, 0, '2020-10-19 14:01:15', 1, null, null);
    '''
    neshieldtestConn.ExecuteSql(sql)
